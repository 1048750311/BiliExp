module.exports = Object.freeze({
    ...
    default_config: {
         ...
         * 符合js正则表达式的字符串
         */
        key_words: ["^((?!恭喜).)*#互动抽奖#((?!恭喜).)*$", "^((?!恭喜).)*#抽奖#((?!恭喜).)*$", ".*(转|抽|评).*(转|抽|评).*(转|抽|评).*","#互动抽奖#", "互动抽奖", "#抽奖#", "#抽奖活动#", "#转发抽奖#", "转发抽奖", "转发+评论", "评论+转发", "#粉丝福利抽奖#", "#动态抽奖#", "动态抽奖", "#粉丝抽奖#", "福利抽奖", "#粉丝福利抽奖#", "抽个奖吧","关注➕转发", "#关注＋转发抽奖#", "#转发+关注抽奖#", "#动态互动抽奖#", "就可以参加抽奖","转发+关注", "#赠书活动#", "随机抽", ".*(转|抽|评).*(转|抽|评).*(转|抽|评).*","抽取", "#关注并转发#"],
         ...
         * "祝${uname}早日百大!"
         */
        chat: ["加油加油","嘿嘿嘿","芜湖","啊这","哇哦","厉害了","好耶","拉低中奖率","冲冲冲","吱吱吱","来了","陪跑","[tv_doge]","支持","[doge]","懂得都懂","挺好","[doge][doge][doge]","捧个人场","捧个人场[doge]","[tv_doge]","[tv_doge][tv_doge]"],
